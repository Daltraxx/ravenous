...
From the landing page is able to enter search terms into business name and location field. They may also select a sort parameter - "Best Match", "Highest Rated", or "Most Reviewed". "Best Match" is the default sort if none is selected.
